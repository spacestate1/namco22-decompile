...
pr1data.8k (Prop Cycle) or tw1data.8k (Tokyo Wars) or dt1dataa.8k (Dirt Dash), the same S22-BIOS ver1.41 chip. SND_GAME=pc|tw|dd and
...
_data = open(f"{ROMDIR}/{ {'pc': 'pr1data.8k', 'tw': 'tw1data.8k', 'dd': 'dt1dataa.8k'}[GAME] }", 'rb').read()
def source(addr, n):
