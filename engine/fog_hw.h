/*
 * fog_hw.h — Super 22 CZ depth fog + poly/screen fade (engine/fog_hw.c, shared by every Super 22 game).
 *
...
/* Build a fog_state from a board's registers (see engine/fog_hw.c): the 0x400-byte mixer, the eight host-order
 * czattr words and four banks of 256 host-order czram words. fog_load_regs() puts it in g_fog / g_fog_valid. */
