...
Version:        %{_ver}
Release:        1%{?dist}
Summary:        Prop Cycle and Rave Racer -- decompiled Namco System 22 engines
...
%description
Native, decompiled engines for the Namco arcade games Prop Cycle (1996) and
Rave Racer (1995), rendered with OpenGL.

NO GAME DATA IS INCLUDED. After installing, put the MAME ROM sets in
~/.local/share/namco22/propcycle/roms/ (propcycl.zip) and
~/.local/share/namco22/raverace/roms/ (raverace.zip, namcoc74.zip).
